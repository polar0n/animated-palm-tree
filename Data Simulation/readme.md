...
Applies different missing-data mechanisms:
 MCAR MAR MNAR booklet/custom designs
...
3. **For MNAR, you *must provide your own missingness function*.**  
...
5. **The simulation engine assumes binary items (2PL/3PL).**  

   - Polytomous items (GRM/GPCM) will require extending `simulate_irt_data()`.  
   - Currently not supported.

6. **The returned object from `run_scenario()` is standardized across all scenarios.**  
