...
- Add polytomous data generation  
- Add multidimensional latent space  
- Add VAE interface  
- Add evaluation metrics (bias/RMSE/imputation accuracy)  
- Add batch simulation wrapper  

This Rmd is ready for deployment.
